        ...
        try {
            const response = await axios.post(
                import.meta.env.VITE_BACKEND_API +
                    "/v1/student/assignment/uploadSolution?assignmentId=65bd15fc0b2169b2a959de6a",
                formData,
        ...
        <div className="m-8 max-[500px]:pl-5 flex flex-col justify-center w-[18rem] rounded-[15px] overflow-hidden shadow-lg border border-[#7F7F7F]">
            ...
            {isUploaded ? (
                ...
                <button
                    ...
                    className="bg-[#004BB8] w-4/5 rounded-[10px] font-medium text-sm text-white p-2 mt-5 ml-7"
                >
                    View Question
                </button>
            )}
            ...
            {isUploaded ? (
                ...
                <button
                    ...
                    className="bg-[#004BB8] w-4/5 rounded-[10px] font-medium text-sm text-white p-2 mt-2 mb-5 ml-7"
                >
                    Upload Solution
                </button>
            )}
