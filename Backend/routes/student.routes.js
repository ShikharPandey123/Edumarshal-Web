...
router.post("/profile/document",auth,upload.single('document'), studentController.uploadDocument);
...
router.post("/assignment/uploadSolution",auth,upload.single('document'),studentController.uploadAssignmentSolution);
